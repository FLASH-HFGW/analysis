...
for event in mf:
    ...
    if "SPEC" in event.banks:
        ...
        for mode_name, (ch_i, ch_q, ch) in iq_modes.items():
            ...
            if ch == 0:
                fft_amp_mode0_SPECs[event_number] = {"amp":fft_amp_chunks,"fs_meta":fs_meta}
                
            elif ch == 1:
                fft_amp_mode1_SPECs[event_number] = {"amp":fft_amp_chunks,"fs_meta":fs_meta}
                
            else: 
                fft_amp_mode2_SPECs[event_number] = {"amp":fft_amp_chunks,"fs_meta":fs_meta}
